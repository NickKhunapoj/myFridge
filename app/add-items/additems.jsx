            ...
            <div className="sticky w-full h-[calc(89vh-120px)] p-16">
                <div className="sticky w-full h-full bg-[#142741] rounded-[33px] shadow-[0px_0px_10px_3px_#00000040] backdrop-blur-[50px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(50px)_brightness(100%)]">
                    ...
                    <div className="flex">
                        ...
                        <input
                            type="date"
                            className="w-52 mt-4 pl-2 rounded-xl bg-[#21253180] text-white backdrop-blur-[50px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(50px)_brightness(100%)] dark:text-gray-100  hover:bg-[#41465680] transition-all duration-300 ease-in-out"
                            style={{ color: "white" }} // Set text color to white
                    ...
                    >
                        ...
                        />
                        <span className="text-[21px] hover:text-[23px] text-white transition-all duration-300 ease-in-out">Add</span> {/* Added text here */}
                        </div>
                    </button>
                    <button
